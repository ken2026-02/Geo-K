...
CREATE INDEX IF NOT EXISTS idx_requirements_jurisdiction ON requirements(jurisdiction);
...
CREATE INDEX IF NOT EXISTS idx_methods_jurisdiction ON methods(jurisdiction);
