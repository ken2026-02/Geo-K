    ...
    >
      ...
      <section style={{ marginBottom: "1rem", border: "1px solid #e5e7eb", borderRadius: "0.75rem", padding: "0.75rem", background: "#fff" }}>
        ...
        <div style={{ display: "flex", gap: "0.5rem", marginTop: "0.5rem", flexWrap: "wrap" }}>
          <button type="button" onClick={() => void handleValidateImport()} disabled={!importRawJson.trim()}>Validate Learning Pack</button>
          <button type="button" onClick={() => void handleImport()} disabled={!importRawJson.trim()}>Import Learning Pack</button>
        </div>
